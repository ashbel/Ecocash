...
/**
 * Created by ashbelh on 8/4/2018.
 */

public class HomeListAdapter extends ArrayAdapter<dbMonths> {
    ...
    public HomeListAdapter(Context context, List<dbMonths> myDataset) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            rowView = inflater.inflate(R.layout.row_layout_home, parent, false);
